...
--
-- Enclose DEFINE values that contain blanks in single quotes.
-- The SQL*Plus/SQLcl DEFINE parser removes those delimiters before substitution,
-- so CAROUSEL_INTERVAL can expand directly into SNAPSHOT MODE EVERY DDL.
