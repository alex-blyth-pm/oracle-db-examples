...
gDBClone is not used by Labs 01-03, which use SQL PDB snapshot and cloning operations.
It is a minimum requirement for the forthcoming CDB thin-clone labs.
